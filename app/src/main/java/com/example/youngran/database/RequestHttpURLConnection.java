...
public class RequestHttpURLConnection {
    public String request(String _url, ContentValues _params){
        ...
        String PASSWORD = "1howtobiz!";

        Log.i("httpreqrespon", "start request");
        ...
        try{
            ...
            if (urlConn.getResponseCode() != HttpURLConnection.HTTP_OK){
                Log.i("httpreqrespon", "connection fail");
                return null;
            }
            ...
            e.printStackTrace();
            Log.i("httpreqrespon", "malform error");
        } catch (IOException e) { // for openConnection().
            e.printStackTrace();
            Log.i("httpreqrespon", "io error");
        } finally {
            if (urlConn != null)
                urlConn.disconnect();
        }
